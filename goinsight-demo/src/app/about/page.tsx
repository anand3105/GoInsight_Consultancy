...
export const metadata = createPageMetadata({
  ...
  description:
    "Founded by Fortune 500 veterans, GoInsight transforms raw data into strategic decisions. 50+ enterprise clients, 100+ projects, 10+ industries served with custom analytics.",
  keywords: [
    "about GoInsight",
